...
namespace RestaurantPaymentSystem.Tests.DB
{
    public static class Constants
    {
        ...
        {
            new Subcategory {Id = 1, SubcategoryName = "Subcategory0", CategoryId = 1},
            new Subcategory {Id = 2, SubcategoryName = "Subcategory1", CategoryId = 1},
            new Subcategory {Id = 3, SubcategoryName = "Subcategory2", CategoryId = 1}
        };

        public static readonly Subcategory[] SubcategoriesNotInDatabase =
        {
            new Subcategory {Id = 100, SubcategoryName = "Subcategory3", CategoryId = 1},
